...
const Header = () => {
    ...
    return (
        <div className={`w-full h-12 flex justify-end`}>
            ...
            <div
                id="header"
                className={`w-full ${scrollState === 2 ? "bg-red-400" : "bg-transparent"
                    } h-12 flex justify-center transition-all duration-300 ${scrollState === 2 ? "fixed" : "relative"
            ...
            >
                ...
                {screenSize < breakpoints.md ? <button className={`relative focus:outline-none bg-green-300 rounded-full z-30 right-3 h-8 w-8 transition-all duration-300 self-center flex justify-center items-center p-2`} onClick={() => {

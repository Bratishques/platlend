...
const TeamIconText = ({ title, text, icon = "" }) => {
  return (
    <div
      className={`group flex md:flex-row mb-10 justify-center flex-col`}
    >
      <div
      ...
      >
        <h4
          className={`text-2.6r font-titles leading-loose font-semibold tracking-wide`}
        >
          {title}
        </h4>
        <p
          className={`text-3xl pr-8 leading-normal pb-8 mt-4 min-h-40 text-subtext`}
        >
          {text}
        </p>
      </div>
